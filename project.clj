(defproject ont-app/inference "0.1.0-SNAPSHOT"
  :description "FIXME"
  :url "https://github.com/ont-app/inference"
  ...
  ;; :main ^:skip-aot ont-app.inference.core
  ...
  :cljsbuild
  {
   ...
   :builds
   {
    :dev {:source-paths ["src"]
           :compiler {
                      :main ont-app.inference.core 
                      :asset-path "js/compiled/out"
                      :output-to "resources/public/js/inference.js"
